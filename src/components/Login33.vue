    ...
    <div class="main">
      ...
      >
        <form class="form" id="a-form" method="" action="">
          <h2 class="form_title title1">周报系统-注册</h2>
      ...
      >
        <form class="form" id="b-form" method="">
          ...
          <span class="form__span">or use your email username</span>
          <input
            class="form__input"
            type="text"
            placeholder="Username"
      ...
      <div class="switch" id="switch-cnt">
        <div
          :class="{ switch__container: true, 'is-hidden': isActive }"
          id="switch-c1"
        >
          <h2 class="switch__title title1">Welcome Back !</h2>
          <p class="switch__description description">
            To keep connected with us please login with your personal info
          </p>
          <button class="switch__button button switch-btn" @click="flip()">
            SIGN IN
          </button>
        </div>
        <div
          ...
          id="switch-c2"
        >
          <h2 class="switch__title title1">Hello Friend !</h2>
          <p class="switch__description description">
